  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto text-center">
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-violet-700 mb-8 ">
...
const ServiceItem = ({ icon, title, reason }) => {
  return (
    <div className="p-6 rounded-md shadow-md transition duration-300 transform hover:scale-105">
      <div className="text-5xl text-violet-700 mb-4">{icon}</div>
